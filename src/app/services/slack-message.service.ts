...
export class SlackMessageService {
  ...
  private isDeploymentMessage(message: any): boolean {
    ...
    const deploymentPatterns = [
      ...
      /(STARTED|SUCCESSFUL|FAILED|FAILURE):\s*Job\s+'([^']+)\s+\[(\d+)\]'\s*\((<)?([^)>]+)(>)?\)/,
      /(STARTED|SUCCESSFUL|FAILED|FAILURE):\s*Job\s+"([^"]+)\s+\[(\d+)\]"\s*\((<)?([^)>]+)(>)?\)/,
      /(STARTED|SUCCESSFUL|FAILED|FAILURE):\s*Job\s+([^\s]+)\s+\[(\d+)\]\s*\((<)?([^)>]+)(>)?\)/,
      /(STARTED|SUCCESSFUL|FAILED|FAILURE):\s*([^\s]+)\s+\[(\d+)\]\s*\((<)?([^)>]+)(>)?\)/,
  ...
  private parseDeploymentMessage(message: any): SlackDeploymentMessage | null {
    ...
    const deploymentPatterns = [
      ...
      /(STARTED|SUCCESSFUL|FAILED|FAILURE):\s*Job\s+'([^']+)\s+\[(\d+)\]'\s*/,
      /(STARTED|SUCCESSFUL|FAILED|FAILURE):\s*Job\s+"([^"]+)\s+\[(\d+)\]"/,
      /(STARTED|SUCCESSFUL|FAILED|FAILURE):\s*Job\s+([^\s]+)\s+\[(\d+)\]/,
      /(STARTED|SUCCESSFUL|FAILED|FAILURE):\s*([^\s]+)\s+\[(\d+)\]/,
      /(STARTED|SUCCESSFUL|FAILED|FAILURE):\s*([^\s]+)/,  // Most flexible
      /Successfully parsed deployment:\s*(STARTED|SUCCESSFUL|FAILED|FAILURE)\s*-\s*([^\s]+)\s+\[(\d+)\]/,  // Test message format
      /(STARTED|SUCCESSFUL|FAILED|FAILURE)\s*-\s*([^\s]+)\s+\[(\d+)\]/  // Simple format
    ];
